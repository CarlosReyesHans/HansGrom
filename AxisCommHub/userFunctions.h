 ...
 * */
int8_t ecat_SPIConfig(SPI_HandleTypeDef* handlerPtr);	//TODO Update the call of the SPI handletype
 ...
 * */
int8_t ledDMA_configCh (TIM_HandleTypeDef* handlerPtr);	//TODO Change to a pwm hanlder

/**
 * @brief	De-initialize a PWM at the given channel
 * */
void ledDMA_deinit (TIM_HandleTypeDef* handlerPtr);	//TODO Change to a pwm handler
