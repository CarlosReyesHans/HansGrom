...
#define ESC_CSR_BUILD_8REG		0x02
#define ESC_CSR_FMMUS_OFFSET	0x04
#define ESC_CSR_SyncManagers_OFFSET	0x05
#define ESC_CSR_RW_ALIAS_ADDRESS	0x13
#define ESC_CSR_ESC_CTRL_REG	0x100
#define ESC_CSR_PDI_CTRL_REG	0x140
